...
\usepackage{booktabs} % Cho đường kẻ bảng chuẩn học thuật
\usepackage{tabularx} % Tự động xuống dòng và căn chỉnh độ rộng cột
...
\subfile{Chuong/0_1_Gioi_thieu_thanh_vien.tex}
...
\titlecontents{chapter}
    ...
    {}         % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
\chapter{QUY TRÌNH KIỂM TRA ĐÁNH GIÁ LỖ HỔNG}
